        ...
        <div class="well">
            <form action="index.html" class="row-fluid">
                ...
                <div class="control-group">
                    ...
                    <div class="controls"><input class="span12" type="password" name="cpass" placeholder="confirm password" /></div>
                </div>
				
				<div class="control-group">
                    <label class="control-label">Email:</label>
                    <div class="controls"><input class="span12" type="text" name="mail" placeholder="mail address" /></div>
                </div>

                <div class="login-btn"><input type="submit" value="Register me" class="btn btn-danger btn-block" /></div>
            </form>
        </div>
    </div>
    <!-- /login block -->
