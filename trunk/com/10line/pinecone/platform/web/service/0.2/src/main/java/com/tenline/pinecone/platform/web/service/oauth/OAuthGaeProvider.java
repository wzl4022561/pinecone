 ...
 *
 */
public class OAuthGaeProvider implements OAuthProvider {

	private String realm;
	private PersistenceManagerFactory pmf;
	private Cache requestTokens;
	private Cache accessTokens;
	private final static int EXPIRATION_MILLIS = 1000 * 3600; // 1 hour
	
	/**
	 * 
	 */
	public OAuthGaeProvider() {
	 ...
	 * @param realm
	 */
	public OAuthGaeProvider(String realm){
		// TODO Auto-generated constructor stub
		try {
			this.realm = realm;
	        ...
	        requestTokens = CacheManager.getInstance().getCacheFactory().createCache(new HashMap<Integer, Integer>());
	        accessTokens = CacheManager.getInstance().getCacheFactory().createCache(props);
