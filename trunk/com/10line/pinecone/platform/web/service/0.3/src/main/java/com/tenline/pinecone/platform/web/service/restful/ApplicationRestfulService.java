...
public class ApplicationRestfulService extends JdoDaoSupport implements ApplicationService {
	...
	public Application create(Application application) {
		// TODO Auto-generated method stub
		application.setUser(getJdoTemplate().getObjectById(User.class, application.getUser().getId()));
		application.setConsumer(getJdoTemplate().getObjectById(Consumer.class, application.getConsumer().getId()));
	...
	public Application update(Application application) {
		...
		if (application.isDefault() != null) detachedApplication.setDefault(application.isDefault());
		if (application.getStatus() != null) detachedApplication.setStatus(application.getStatus());
	...
	@Override
	public Collection<Application> showByConsumer(String filter) {
		// TODO Auto-generated method stub
