...
public class OAuthUtils {
	...
	public static OAuthProvider getOAuthProvider() {
		return (OAuthProvider) properties.get(ATTR_OAUTH_PROVIDER);
	}
	 ...
	 */
	public static void doFilter(HttpServletRequest request, HttpServletResponse response)throws IOException, ServletException {
		OAuthProvider provider = OAuthUtils.getOAuthProvider();
        try{
