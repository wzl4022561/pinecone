...
public class OAuthPersistentProvider extends JdoDaoSupport implements OAuthProvider {
	...
	public Consumer registerConsumer(String consumerKey,
        ...
        return getJdoTemplate().detachCopy(getJdoTemplate().makePersistent(new Consumer(consumerKey, makeRandomString(), displayName, connectURI)));
	}
	...
	private Consumer findConsumer(String consumerKey) throws OAuthException {
		...
		Collection<Consumer> consumers = getJdoTemplate().detachCopyAll(getJdoTemplate().find(queryString));
