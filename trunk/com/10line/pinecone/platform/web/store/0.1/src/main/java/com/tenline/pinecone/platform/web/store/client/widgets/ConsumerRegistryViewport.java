...
public class ConsumerRegistryViewport extends AbstractViewport {
	...
	private class MainPanel extends ContentPanel{
		...
		public MainPanel(){
			...
			TabItem tbtmApplication = new TabItem("Application");
			...
			ComboBox<BeanModel> cmbxCategory = new ComboBox<BeanModel>();
			...
			cmbxCategory.setFieldLabel("Category");
			...
			txtfldSecret.setFieldLabel("Secret");
			...
			txtfldConnectUri.setFieldLabel("Connect URI");
			...
			txtfldAlias.setFieldLabel("Alias");
			...
			txtfldVersion.setFieldLabel("Version");
			...
			mltfldIconUpload.setFieldLabel("Icon Upload");
