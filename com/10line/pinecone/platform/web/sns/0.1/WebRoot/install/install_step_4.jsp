...
<%
	try{
		...
		mails.put("server","smtp.163.com");
		mails.put("port",25);
		mails.put("auth",1);
		mails.put("from","liu_guo_1982@163.com");
		mails.put("auth_username","liu_guo_1982@163.com");
		mails.put("auth_password","198297");
		
		//use http://elasticemail.com to send mail
		mails.put("elastic_username","liugy503@gmail.com");
		mails.put("elastic_api_key","1511bd2f-208e-4647-ac73-c6306545b505");
		mails.put("elastic_from","liugy503@gmail.com");
		mails.put("elastic_fromname","松果网");
		mails.put("elastic_frommail","liugy503@gmail.com");
