 ...
 *
 */
public class ChannelService extends AbstractService implements Protocol {
	 ...
	 * Open data channel.
	 */
	public void listen(ChannelServiceListener aListener) throws PushletException {
	 ...
	 */
	public void listen(ChannelServiceListener aListener, String aMode) throws PushletException {
	 ...
	 */
	public void listen(ChannelServiceListener aListener, String aMode, String aSubject) throws PushletException {
		throwOnInvalidSession();
		stopListen();
	 ...
	 */
	public void joinListen(ChannelServiceListener aListener, String aMode, String aSubject) throws PushletException {
		stopListen();
	 ...
	 */
	protected void startDataEventListener(ChannelServiceListener aListener, String aListenURL) {
	...
	protected class DataEventListener implements Runnable {
		 ...
		 */
		private ChannelServiceListener listener;
		...
		public DataEventListener(ChannelServiceListener aListener, String aListenURL) {
			listener = aListener;
		 ...
		 */
		protected void handleUnknownEventType(String eventType, Event event, ChannelServiceListener listener) {
